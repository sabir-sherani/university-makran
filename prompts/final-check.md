<!-- Self-contained instruction file for the Claude Code agent.
     Paste into the agent:  Read prompts/final-check.md and do exactly what it says.  -->

# FINAL VERIFICATION — run only after Phase 6 is complete
...
# PART 2 — THE WORK: FINAL VERIFICATION
